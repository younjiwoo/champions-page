...
export const itemJson = {
	...
	data: {
		...
		1055: {
			name: '도란의 검',
			description:
				'<stats>공격력 +8<br>체력 +80<br>생명력 흡수 +3%</stats>',
		...
		1416: {
			...
			colloq: '',
			plaintext:
				'공격 속도가 증가하고 대상의 체력에 비례한 피해를 입힙니다.',
			from: ['1043', '3706'],
			hideFromAll: true,
			image: {
				full: '1416.png',
		...
		2031: {
			...
			colloq: ';',
			plaintext:
				'일정 시간 동안 체력이 회복되며, 상점에 가면 다시 충전됩니다.',
			into: ['2033'],
			image: {
				full: '2031.png',
				sprite: 'item0.png',
		...
		2047: {
			...
			plaintext:
				'챔피언이 투명하거나 보이지 않는 적 유닛을 볼 수 있게 됩니다.',
			consumed: true,
			consumeOnFull: true,
			image: {
				full: '2047.png',
		...
		3005: {
			...
			colloq: ";심판;atma;reckoning;atma's reckoning;dkxmak;dkxmakdml tlavks;dkxmakdmltlavks",
		...
		3025: {
			...
			plaintext:
				'스킬을 시전한 후 기본 공격을 하면 둔화 역장이 생성됩니다.',
			from: ['3057', '3024'],
			into: ['3387'],
			image: {
				full: '3025.png',
		...
		3041: {
			...
			plaintext:
				'챔피언을 처치하거나 어시스트를 올릴 경우, 주문력이 오릅니다.',
			from: ['1082'],
			image: {
				full: '3041.png',
				sprite: 'item0.png',
		...
		3071: {
			...
			plaintext:
				'적 챔피언에게 물리 피해를 입히면 적의 방어력이 감소합니다.',
			from: ['3044', '3067'],
			into: ['3380'],
			image: {
				full: '3071.png',
		...
		3074: {
			...
			plaintext:
				'근접 공격으로 주변의 적에게 피해를 주면 체력이 회복됩니다. ',
			from: ['3077', '1053', '1037'],
			image: {
				full: '3074.png',
				sprite: 'item0.png',
		...
		3085: {
			...
			plaintext:
				'원거리 공격 시 주변의 적들에게 두 발의 탄환을 발사합니다.',
			from: ['1042', '3086', '1042'],
			image: {
				full: '3085.png',
				sprite: 'item1.png',
		...
		3087: {
			...
			colloq: ';statikk;shiv',
			plaintext:
				'이동 시 점차 충전되어, 기본 공격 시 연쇄 번개를 발사합니다.',
			from: ['3086', '2015'],
			image: {
				full: '3087.png',
				sprite: 'item1.png',
		...
		3111: {
			...
			plaintext:
				'이동 속도가 증가하고, 방해 효과의 지속시간이 줄어듭니다.',
			from: ['1001', '1033'],
			image: {
				full: '3111.png',
				sprite: 'item1.png',
		...
		3128: {
			...
			plaintext:
				'사용하면 적 챔피언에게 가하는 모든 마법 피해량이 증가합니다.',
			from: ['1058', '3108'],
			image: {
				full: '3128.png',
				sprite: 'item1.png',
		...
		3387: {
			...
			plaintext:
				'스킬을 사용한 후 기본 공격을 하면 둔화 역장이 생성됩니다.',
			from: ['3025'],
			requiredAlly: 'Ornn',
			image: {
				full: '3387.png',
		...
		3685: {
			...
			colloq: '',
			plaintext:
				'왕: 자신의 뒤에 회오리바람을 소환하여 앞으로 발사합니다.',
			image: {
				full: '3685.png',
				sprite: 'item2.png',
				group: 'item',
		...
		4001: {
			...
			colloq: ';',
			plaintext:
				'이동 속도가 상승하며 잠시 동안 벽을 통과할 수 있습니다.',
			from: ['1001'],
			image: {
				full: '4001.png',
				sprite: 'item2.png',
		...
		4105: {
			...
			colloq: '',
			plaintext:
				'공격 시 대상의 최대 체력에 비례해 추가 피해를 입힙니다.',
			from: ['1043', '4101'],
			hideFromAll: true,
			image: {
				full: '4105.png',
